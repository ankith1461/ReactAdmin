...
import FatawaData from "Data/FatawaData.js";
...
class Fatawa extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      sampleData : FatawaData,
            ...
            <Col lg="12" md="12">
              <Card className="card-tasks">
                ...
                <CardBody>
                      ...
                      <tbody>
                        {
                          this.state.sampleData.map( data => {
                            return <tr>
                                ...
                                <td>
                                 <p className={data.answer =='' ? 'text-muted':''}>
                                   Question : {data.question}
                                  </p>
                                  <p >
                                    { 
                                      data.answer!=='' ? ('Answer : ' + (data.answer).substring(0,200) + ' . . .') : ''
                                    }
                                  </p>
                                </td>
                                <td className="td-actions text-right">
                                  ...
                                  <Link to={{ pathname:'/admin/edit-form',
                                              state: {
                                                ...
                                                formTitle: data.question,
                                                
                                                formDescription: data.answer,
                  ...
                  <div><p> Note : The Unhighlighted questions are unaswered</p></div>
                </CardBody>
              </Card>
            </Col>
